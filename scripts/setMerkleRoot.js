 ...
 *   using the `setMerkleRoot` function defined in MetaJetzSparrow977.sol contract. For this script to work your contract
...
async function main() {
  const nftFactory = await hre.ethers.getContractFactory('MetaJetzSparrow977')
  const nftContract = await nftFactory.attach(
    '0x9B24C686d90edfbF9F28E9F92Fc5438C5b22CE90' // Deployed contract address
  )
